...
<h2>Introduzione</h2>
<p>La presente Informativa ha lo scopo di informare l'utente circa le modalità di trattamento dei dati personali che lo riguardano.
<p>[short_company_name], in linea con il D.lgs. 196/2003 (di seguito "Codice Privacy") e il Regolamento (UE) 2016/679 (di seguito "GDPR"), intende garantire la privacy e la sicurezza dei dati personali di ciascun visitatore coerentemente con quanto prescritto nella presente Informativa.</p>
<p><strong>La presente Informativa è da intendersi quale informativa ai sensi dell'art. 13 del Codice Privacy e degli artt. 13 e 14 del GDPR.</strong></p>
<h2>Titolare del Trattamenti dei dati</h2>
<p>Il Titolare del trattamento dei dati è, nella persona del suo titolare:<br>
    <strong>[full_company_name]</strong><br>
    [full_address]
</p>
<p>P. IVA:[vat]<br> Telefono:[phone_number]<br> Email: [email]</p>
...
<p>Il sito web può utilizzare i c.d. social plug-in. I social plug-in sono speciali strumenti che permettono di incorporare le funzionalità del social network direttamente all'interno del sito web (ad es. la funzione "mi piace" di Facebook).</p>
<p>Tutti i social plug-in presenti nel sito sono contrassegnati dal rispettivo logo di proprietà della piattaforma di social network (ad es. Facebook, Google, Twitter, Linkedin).</p>
<p>Quando si visita una pagina del nostro sito e si interagisce con il plug-in (ad es. cliccando il pulsante "Mi piace") o si decide di lasciare un commento, le corrispondenti informazioni vengono trasmesse dal browser direttamente alla piattaforma di social network e da questo memorizzate.</p>
...
<p> In relazione al trattamento dei suoi dati personali, ha diritto di chiedere al Titolare.:
<ul>
...
<ul>
    ...
    <li>Cookie statistici anonimi (cookie di terza parte): si tratta di cookie statistici (Google Analytics) installati da Google Inc. Questi cookie statistici utilizzano la tecnica dell'anonimizzazione dell'indirizzo IP (si veda <a href="https://support.google.com/analytics/answer/2763052?hl=it">Anonimizzazione IP in analytics</a>) e quindi non memorizzano alcun dato personale dell'utente ma solo dati statistici aggregati. Le ricordiamo inoltre che sono disponibili <a href="https://tools.google.com/dlpage/gaoptout/">idonei strumenti</a> forniti da Google stesso per la disattivazione dei cookie di Google Analitycs. Ulteriori informazioni sulla privacy in Google Analytics sono disponibili a <a href="https://www.google.com/intl/it_it/analytics/learn/privacy.html">questo link</a>.</li>
</ul>
