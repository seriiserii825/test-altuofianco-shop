...
<div class="single-product-page">
	...
	$image = get_template_directory_uri() . '/assets/i/static/single.jpg';
	?>
	<div class="single-product-page__intro">
		<?php require_once __DIR__ . '/../components/page-intro.php'; ?>
		<?php pageIntroComponent($title, $image, $subtitle); ?>
		<ul class="single-product-page__breadcrumbs breadcrumb-list">
			<li>
			...
			<li>
				<a href="<?php echo home_url(); ?>/product-category/<?php echo $terms[0]->slug; ?>">
